class PairsController < ApplicationController
  before_action :set_pair, only: [:show, :edit, :update, :destroy, :history]
  ...
  def history
    @pair.update_candles if @pair.candles.empty?||@pair.candles_old?
    opts   = { :width => 1000, :height => 600, :legend => 'none' }
    @chart = GoogleVisualr::Interactive::CandlestickChart.new(@pair.chart_data, opts)
  end
